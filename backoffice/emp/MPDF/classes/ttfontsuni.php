...
class TTFontFile
{
    ...
    function getMetrics($file, $TTCfontID = 0, $debug = false, $BMPonly = false, $kerninfo = false, $unAGlyphs = false)
    {    // mPDF 5.4.05
    ...
    function getCTG($file, $TTCfontID = 0, $debug = false, $unAGlyphs = false)
    {    // mPDF 5.4.05
        $this->unAGlyphs = $unAGlyphs;    // mPDF 5.4.05
        $this->filename = $file;
        $this->fh = fopen($file, 'rb') or die('Can\'t open file ' . $file);
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    function makeSubset($file, &$subset, $TTCfontID = 0, $debug = false, $unAGlyphs = false)
    {    // mPDF 5.4.05
        $this->unAGlyphs = $unAGlyphs;    // mPDF 5.4.05
        $this->filename = $file;
        $this->fh = fopen($file, 'rb') or die('Can\'t open file ' . $file);
...
//================================================================================
    ...
    function repackageTTF($file, $TTCfontID = 0, $debug = false, $unAGlyphs = false)
    {    // mPDF 5.4.05
        $this->unAGlyphs = $unAGlyphs;    // mPDF 5.4.05
        $this->filename = $file;
        $this->fh = fopen($file, 'rb') or die('Can\'t open file ' . $file);
